...
<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
    ...
    <li class="breadcrumb-item"><a href="{{ url('siswa') }}">Users</a></li>
...
<div class="col-xl-8 order-xl-1">
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ url('siswa/'.$updateSiswa->id) }}" method="POST">
          @csrf
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control" value="{{ $updateSiswa->name }}"> 
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label" for="input-email">Role</label>
                  <input type="text" name="role" class="form-control" value="{{ $updateSiswa->role }}">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" name="email" class="form-control" value="{{ $updateSiswa->email }}">
                </div>
              </div>
            </div>
