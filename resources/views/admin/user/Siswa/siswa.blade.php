    ...
    <div class="col">
      <div class="card bg-default shadow">
        <div class="card-header bg-transparent border-0">
          <h3 class="text-white mb-0">Siswa Table</h3>
          ...
          <table class="table align-items-center table-dark table-flush">
            ...
            <tbody class="list">
                ...
                <tr>
                    ...
                    <div class="media-body">
                      <span class="name mb-0 text-sm">{{ $siswa->name }}</span>
                    </div>
                </div>
            </th>
            <td class="budget">
            ...
            <td>
                  <span class="badge badge-dot mr-4">
                      ...
                      <span class="status">{{ $siswa->email }}</span>
                    </span>
                </td>
                <td class="d-flex flex-row text-center" style="cursor: pointer">
