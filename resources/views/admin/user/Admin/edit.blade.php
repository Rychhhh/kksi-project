            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control" value="{{ $updateAdmin->name }}"> 
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label" for="input-email">Role</label>
                  <input type="text" name="role" class="form-control" value="{{ $updateAdmin->role }}">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" name="email" class="form-control" value="{{ $updateAdmin->email }}">
                </div>
              </div>
            </div>
